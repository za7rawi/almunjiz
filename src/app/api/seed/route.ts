...
export async function GET() {
  try {
    ...
    const gateways = [
      { name: 'Tap Payments', slug: 'tap', provider: 'TAP', displayName: 'تاب', displayNameEn: 'Tap', description: 'بوابة دفع تاب - فيزا وماستركارد وMADA', descriptionEn: 'Tap Payment Gateway - Visa, Mastercard & MADA', isActive: false, isDefault: false, sortOrder: 1, environment: 'SANDBOX', supportsApplePay: true, supportsGooglePay: true, supportedCurrencies: ['SAR', 'USD', 'AED'], supportedCountries: ['SA', 'AE', 'KW', 'BH', 'OM', 'QA'] },
      { name: 'Moyasar', slug: 'moyasar', provider: 'MOYASAR', displayName: 'ميسر', displayNameEn: 'Moyasar', description: 'بوابة دفع ميسر - فيزا وماستركارد وMADA وApple Pay', descriptionEn: 'Moyasar Payment Gateway - Visa, Mastercard, MADA & Apple Pay', isActive: false, isDefault: false, sortOrder: 2, environment: 'SANDBOX', supportsApplePay: true, supportsGooglePay: false, supportedCurrencies: ['SAR'], supportedCountries: ['SA'] },
      { name: 'STC Pay', slug: 'stc_pay', provider: 'CUSTOM', displayName: 'إس تي سي باي', displayNameEn: 'STC Pay', description: 'محفظة STC Pay للدفع عبر الجوال', descriptionEn: 'STC Pay mobile wallet payment', isActive: false, isDefault: false, sortOrder: 3, environment: 'SANDBOX', supportsApplePay: false, supportsGooglePay: false, supportedCurrencies: ['SAR'], supportedCountries: ['SA'] },
      { name: 'Bank Transfer', slug: 'bank_transfer', provider: 'CUSTOM', displayName: 'تحويل بنكي', displayNameEn: 'Bank Transfer', description: 'الدفع عبر التحويل البنكي المباشر', descriptionEn: 'Direct bank transfer payment', isActive: false, isDefault: true, sortOrder: 99, environment: 'PRODUCTION', supportsApplePay: false, supportsGooglePay: false, supportedCurrencies: ['SAR', 'USD', 'AED'], supportedCountries: ['SA', 'AE', 'KW', 'BH', 'OM', 'QA', 'EG', 'JO'] },
    ];
